...
export const INVERSE_COORDINATION_MATRIX_CUSTOM_KEY = '__bakaInverseCoordinationMatrixJson'
export const PLACEMENT_POSITION_CUSTOM_KEY = '__bakaPlacementPositionJson'
export const SPACE_RELATIVE_POSITION_CUSTOM_KEY = '__bakaSpaceRelativePositionJson'
